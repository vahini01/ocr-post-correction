...
train_src="$OCRPATH/training/train2_src1.txt"
train_tgt="$OCRPATH/training/train2_tgt.txt"

dev_src="$OCRPATH/training/dev2_src1.txt"
dev_tgt="$OCRPATH/training/dev2_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_2_seed1_base/"
