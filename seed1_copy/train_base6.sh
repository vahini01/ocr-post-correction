...
train_src="$OCRPATH/training/train6_src1.txt"
train_tgt="$OCRPATH/training/train6_tgt.txt"

dev_src="$OCRPATH/training/dev6_src1.txt"
dev_tgt="$OCRPATH/training/dev6_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_6_seed1_base/"
