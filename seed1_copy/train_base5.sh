...
train_src="$OCRPATH/training/train5_src1.txt"
train_tgt="$OCRPATH/training/train5_tgt.txt"

dev_src="$OCRPATH/training/dev5_src1.txt"
dev_tgt="$OCRPATH/training/dev5_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_5_seed1_base/"
