...
train_src="$OCRPATH/training/train7_src1.txt"
train_tgt="$OCRPATH/training/train7_tgt.txt"

dev_src="$OCRPATH/training/dev7_src1.txt"
dev_tgt="$OCRPATH/training/dev7_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_7_seed1_base/"
