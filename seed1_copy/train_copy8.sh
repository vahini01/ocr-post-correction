...
train_src="$OCRPATH/training/train8_src1.txt"
train_tgt="$OCRPATH/training/train8_tgt.txt"

dev_src="$OCRPATH/training/dev8_src1.txt"
dev_tgt="$OCRPATH/training/dev8_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_8_seed1_copy/"
