...
SAMPLE="sample1"
HOME="/home/vahini"
OCRPATH="$HOME/way2/ocr-post-correction/$SAMPLE"
POST_PATH="$HOME/way2/ocr-post-correction"
...
train_src="$OCRPATH/training/train1_src1.txt"
train_tgt="$OCRPATH/training/train1_tgt.txt"

dev_src="$OCRPATH/training/dev1_src1.txt"
dev_tgt="$OCRPATH/training/dev1_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_1_seed1_test_base/"
