...
train_src="$OCRPATH/training/train4_src1.txt"
train_tgt="$OCRPATH/training/train4_tgt.txt"

dev_src="$OCRPATH/training/dev4_src1.txt"
dev_tgt="$OCRPATH/training/dev4_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_4_seed1_base/"
