...
train_src="$OCRPATH/training/train3_src1.txt"
train_tgt="$OCRPATH/training/train3_tgt.txt"

dev_src="$OCRPATH/training/dev3_src1.txt"
dev_tgt="$OCRPATH/training/dev3_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_3_seed1_base/"
