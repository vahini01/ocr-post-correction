...
train_src="$OCRPATH/training/train9_src1.txt"
train_tgt="$OCRPATH/training/train9_tgt.txt"

dev_src="$OCRPATH/training/dev9_src1.txt"
dev_tgt="$OCRPATH/training/dev9_tgt.txt"

# Set experiment parameters
expt_folder="$OCRPATH/singlesource_10fold_9_seed1_base/"
